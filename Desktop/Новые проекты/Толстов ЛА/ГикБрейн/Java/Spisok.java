...
public class Spisok {
    public static void main(String[] args) {
        ...
        contactList.addToEnd(new Contact(2, "Солодов Петр", "5716"));
        contactList.addToEnd(new Contact(3, "Сидоров Сидор", "4186"));
        contactList.addToEnd(new Contact(4, "Венин Вениамин", "6584"));
        contactList.addToEnd(new Contact(6, "Семенов Сергей", "9856"));
        contactList.addToEnd(new Contact(7, "Иванов Роман", "5849"));
